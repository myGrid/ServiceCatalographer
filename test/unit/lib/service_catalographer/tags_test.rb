# ServiceCatalographer: test/unit/lib/service_catalographer/tags_test.rb
#
...
class TagsTest < ActionView::TestCase
  ...
  test "#get_total_items_count_for_tag_name" do
    ...
    assert_equal 3, ServiceCatalographer::Tags.get_total_items_count_for_tag_name("e")
    assert_equal 3, ServiceCatalographer::Tags.get_total_items_count_for_tag_name("E")
    assert_equal 2, ServiceCatalographer::Tags.get_total_items_count_for_tag_name("c")
    assert_equal 1, ServiceCatalographer::Tags.get_total_items_count_for_tag_name("a")
    assert_equal 0, ServiceCatalographer::Tags.get_total_items_count_for_tag_name("unknown_tag")
  ...
  test "#get_tags" do
    ...
    tags = ServiceCatalographer::Tags.get_tags
    ...
    # ---
    # With :limit
    tags = ServiceCatalographer::Tags.get_tags(:limit => limit)
    ...
    # ---
    # With :sort => :counts
    tags = ServiceCatalographer::Tags.get_tags(:sort => :counts)
    ...
    tags = ServiceCatalographer::Tags.get_tags(:sort => :counts, :limit => limit)
    ...
    # ---
    # With :sort => :name
    tags = ServiceCatalographer::Tags.get_tags(:sort => :name)
    ...
    tags = ServiceCatalographer::Tags.get_tags(:sort => :name, :limit => limit)
    ...
    tags_page_1 = ServiceCatalographer::Tags.get_tags(:per_page => per_page, :page => 1)
    tags_page_2 = ServiceCatalographer::Tags.get_tags(:per_page => per_page, :page => 2)
    tags_page_3 = ServiceCatalographer::Tags.get_tags(:per_page => per_page, :page => 3)
    tags_page_4 = ServiceCatalographer::Tags.get_tags(:per_page => per_page, :page => 4)
    ...
    tags_page_1 = ServiceCatalographer::Tags.get_tags(:sort => :name, :per_page => per_page, :page => 1)
    tags_page_2 = ServiceCatalographer::Tags.get_tags(:sort => :name, :per_page => per_page, :page => 2)
    tags_page_3 = ServiceCatalographer::Tags.get_tags(:sort => :name, :per_page => per_page, :page => 3)
    tags_page_4 = ServiceCatalographer::Tags.get_tags(:sort => :name, :per_page => per_page, :page => 4)
    ...
    tags_page_1 = ServiceCatalographer::Tags.get_tags(:per_page => per_page, :page => 1, :limit => limit)
    tags_page_2 = ServiceCatalographer::Tags.get_tags(:per_page => per_page, :page => 2, :limit => limit)
    
    tags_page_1 = ServiceCatalographer::Tags.get_tags(:per_page => per_page, :page => 1, :limit => limit)
    tags_page_2 = ServiceCatalographer::Tags.get_tags(:per_page => per_page, :page => 2, :limit => limit)
    tags_page_3 = ServiceCatalographer::Tags.get_tags(:per_page => per_page, :page => 3, :limit => limit)
    tags_page_4 = ServiceCatalographer::Tags.get_tags(:per_page => per_page, :page => 4, :limit => limit)
  ...
  test "#get_total_tags_count" do
    assert_equal @unique_tags_length, ServiceCatalographer::Tags.get_total_tags_count
  end
  
  test "#get_tag_suggestions" do
    assert_equal 1, ServiceCatalographer::Tags.get_tag_suggestions("a").length
    assert_equal 0, ServiceCatalographer::Tags.get_tag_suggestions("nada").length
  end
