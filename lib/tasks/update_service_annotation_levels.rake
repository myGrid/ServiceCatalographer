# ServiceCatalographer: lib/tasks/update_service_annotation_levels.rake
#
  ...
  namespace :curation do
    ...
    task :update_service_annotation_level => :environment do
      Service.all.each  do |service|
        ...
        service.annotation_level = ServiceCatalographer::Curation::AnnotationLevel.annotation_level_for_service(service)
        begin
          service.save!
        rescue Exception => ex
