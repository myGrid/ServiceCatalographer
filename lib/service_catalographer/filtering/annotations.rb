# ServiceCatalographer: lib/service_catalographer/filtering/annotations.rb
#
  ...
  module Filtering
    module Annotations
      ...
      def self.get_filters_for_annotatables(annotatable_type, limit=nil)
        ...
        results.each do |r|
          r['name'] = (objs[r['id']].nil? ? "(not available)" : ServiceCatalographer::Util.display_name(objs[r['id']], false))
        end
