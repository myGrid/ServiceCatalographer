# ServiceCatalographer: lib/service_catalographer/filtering/services.rb
#
      ...
      def self.generate_conditions_and_joins_from_filters(filters, search_query=nil)
        ...
        unless search_query.blank?
          ...
          unless search_results.blank?
            ...
            service_ids_search_query = ServiceCatalographer::Search::Results::get_item_ids(search_results, 'services')
          end
        end
    ...
    protected
      ...
      def self.build_categories_filters(categories)
        ...
        categories.each do |category|
          ...
          filter['count'] = ServiceCatalographer::Categorising.number_of_services_for_category(category)
          filter['children'] = [ ]
      ...
      def self.get_filters_for_tags_by_service_models(model_names, limit=nil, http_cycle=nil)
        ...
        grouped_tags.each do |tag_name, op_ids|
          service_ids = ServiceCatalographer::Mapper.process_compound_ids_to_associated_model_object_ids(op_ids, "Service")
      ...
      def self.get_service_ids_with_tag_on_service_models(model_names, tag_values, http_cycle=nil)
        ...
        return ServiceCatalographer::Mapper.process_compound_ids_to_associated_model_object_ids(results.map{|r| ServiceCatalographer::Mapper.compound_id_for(r['type'], r['id']) }, "Service").uniq
      end
