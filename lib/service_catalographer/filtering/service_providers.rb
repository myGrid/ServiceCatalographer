# ServiceCatalographer: lib/service_catalographer/filtering/service_providers.rb
#
      ...
      def self.generate_conditions_and_joins_from_filters(filters, search_query=nil)
        ...
        unless search_query.blank?
          ...
          unless search_results.blank?
            ...
            service_provider_ids_search_query = ServiceCatalographer::Search::Results::get_item_ids(search_results, 'service_providers')
          end
        end
