# ServiceCatalographer: lib/service_catalographer/filtering/users.rb
#
      ...
      def self.generate_conditions_and_joins_from_filters(filters, search_query=nil)
        ...
        unless search_query.blank?
          ...
          unless search_results.blank?
            ...
            user_ids_search_query = ServiceCatalographer::Search::Results::get_item_ids(search_results, 'users')
          end
        end
