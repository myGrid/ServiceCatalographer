# ServiceCatalographer: lib/service_catalographer/acts_as_service_versionified.rb
#
  ...
  module ActsAsServiceVersionified #:nodoc:
    ...
    module ClassMethods
      def acts_as_service_versionified
        ...
        class_eval do
          extend ServiceCatalographer::ActsAsServiceVersionified::SingletonMethods
        end
        include ServiceCatalographer::ActsAsServiceVersionified::InstanceMethods
    ...
    module InstanceMethods
      ...
      def process_annotations_data(annotations_data, actual_submitter)
        ...
        annotations_data = ServiceCatalographer::Annotations.preprocess_annotations_data(annotations_data)
...
ActiveRecord::Base.send(:include, ServiceCatalographer::ActsAsServiceVersionified)
