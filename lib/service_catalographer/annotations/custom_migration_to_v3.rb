module Annotations
  module Util
    ...
    def self.migrate_annotations_to_v3
      ServiceCatalographer::Util::say "Running custom logic to migrate the Annotations data to the v3 schema..."
      ...
      Annotation.all.each do |ann|
        begin
          ...
          ServiceCatalographer::Util::yell "FAILED to migrate annotation with ID #{ann.id}. Error message: #{ex.message}"
