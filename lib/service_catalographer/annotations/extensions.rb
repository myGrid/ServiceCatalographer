# ServiceCatalographer: lib/service_catalographer/annotations/extensions.rb
#
...
ActiveRecord::Base.send(:include, ServiceCatalographer::Annotations::Extensions::VirtualFieldFromAnnotationWithFallback)