# ServiceCatalographer: lib/service_catalographer/jobs/calculate_annotation_counts_job.rb
#
    ...
    class CalculateAnnotationCountsJob
      def perform
        Service.all.each do |service|
          ...
          ServiceCatalographer::Annotations.metadata_counts_for_service(service, true)
        end
      end    
    end
  end
