# ServiceCatalographer: lib/service_catalographer/json.rb
#
...
module ServiceCatalographer
    ...
    module Json
      ...
      def self.monitoring_status(status)
        {
          ...
          "symbol" => ServiceCatalographer::Api.uri_for_path("/assets/#{status.symbol_filename}"),
          "small_symbol" => ServiceCatalographer::Api.uri_for_path("/assets/#{status.small_symbol_filename}"),
      ...
      def self.location(country, city="")
        ...
        
        {
          ...
          "flag" => ServiceCatalographer::Api.uri_for_path(ServiceCatalographer::Resource.flag_icon_path(country_code))
        }
      end # self.location
      ...
      def self.index(name, params, collection, more={})
        has_filter = ServiceCatalographer::Filtering::FILTER_GROUPS.include?(name.to_sym)
      ...
      def self.api_endpoint
        {
          "servicecatalogue" => {
            ...
            "collections" => [
              ...
              self.api_endpoint_item('search', 'Search', 'Search everything in the ServiceCatalogue'),
  ...
  private # ========================================
      ...
      def self.uri_for(collection)
        ServiceCatalographer::Api.uri_for_collection(collection)
      end # self.uri_for
