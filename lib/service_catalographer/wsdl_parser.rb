# ServiceCatalographer: lib/service_catalographer/wsdl_parser.rb
#
...
module ServiceCatalographer
  module WsdlParser
    ...
    def self.parse_via_wsdlutils(wsdl_url)
      ...
      service_info, error_messages, wsdl_file_contents = ServiceCatalographer::WsdlUtils::ParserClient.parse(wsdl_url)
      ...
      #  Util.warn "Trying the old parser - ServiceCatalographer::WsdlParser::Legacy.parse(...) - because the ServiceCatalographer::WsdlUtils::ParserClient.parse(...) failed"
      #  service_info, error_messages, wsdl_file_contents = ServiceCatalographer::WsdlParser::Legacy.parse(wsdl_url)
      #end
