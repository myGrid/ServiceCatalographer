# ServiceCatalographer: lib/service_catalographer/annotations.rb
#
    ...
    def self.bulk_create(annotation_groups, source)
      ...
      unless annotation_groups.blank?
        annotation_groups.each do |x|
          obj = ServiceCatalographer::Api.object_for_uri(x["resource"])
          unless obj.nil?
            ...
            if x["annotations"].blank?
              ...
              result["annotations"] = ServiceCatalographer::Api::Json.collection(anns)
            end
