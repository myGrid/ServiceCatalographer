# ServiceCatalographer: lib/service_catalographer/stats.rb
#
...
module ServiceCatalographer
  module Stats
    ...
    def self.submit_job_to_refresh_stats
      ...
      unless ServiceCatalographer::DelayedJobs.job_exists?("ServiceCatalographer::Jobs::UpdateStats")
        Delayed::Job.enqueue(ServiceCatalographer::Jobs::UpdateStats.new)
      end
    end
    ...
    class StatsData
      ...
      # ServiceCatalographer::Annotations.metadata_counts_for_service
      #
      # Returns: Integer
      ...
      # { service_id => metadata_counts_hash (as per return value of ServiceCatalographer::Annotations.metadata_counts_for_service) }
      def load_metadata_counts_per_service
        @metadata_counts_per_service = Hash[* Service.all.map{|s| [ s.id, ServiceCatalographer::Annotations.metadata_counts_for_service(s) ] }.flatten]
      end
      ...
      # where type is one of the types available in the results hash of ServiceCatalographer::Annotations.metadata_counts_for_service
      ...
      def load_tags
        @taggings_count = ServiceCatalographer::Tags.get_total_taggings_count
        
        @tags = { }
        tags1 = ServiceCatalographer::Tags.get_tags
        tags2 = ServiceCatalographer::Filtering::Services.get_filters_for_all_tags
