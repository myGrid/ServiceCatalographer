...
# ServiceCatalographer: script/service_catalographer/cleanup_sessions.sh
...
echo "now clear sessions older than 3 days with ...  rake servicecatalographer:remove_expired_sessions RAILS_ENV=production"
rake servicecatalographer:remove_expired_sessions RAILS_ENV=$environment
