...
# ServiceCatalographer: script/service_catalographer/update_query_suggestions.sh
...
echo "Update query suggestions"
rake servicecatalographer:submit:update_search_query_suggestions RAILS_ENV=$environment
