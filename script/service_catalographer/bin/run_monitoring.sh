...
# ServiceCatalographer: script/service_catalographer/annotations_count.sh
...
while getopts "he:" opt; do
	...
	h)
		echo "Description:"
	   	echo "Launches two jobs to run ServiceCatalogue's monitoring in the background process"
		echo "Requirements:"
...
rake servicecatalographer:submit:update_urls_to_monitor RAILS_ENV=$environment

echo "checking the statuses of the urls "

rake servicecatalographer:submit:check_url_status RAILS_ENV=$environment
