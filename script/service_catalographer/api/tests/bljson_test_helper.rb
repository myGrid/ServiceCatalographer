# ServiceCatalographer: script/service_catalographer/api/tests/bljson_test_helper.rb
#
...
module BljsonTestHelper
  ...
  def load_data_from_endpoint(endpoint_url)
    JSON.parse(open(endpoint_url, "Accept" => "application/servicecatalographer-lite+json", "User-Agent" => HTTP_USER_AGENT).read)
  end
