...
# This script imports most of the data from Feta into ServiceCatalogue.
#
...
class FetaImporter
  ...
  def run
    ...
    puts ""
    puts ""
    puts "=> Booting Feta to ServiceCatalogue import process. Running on #{@options[:environment]} database."
