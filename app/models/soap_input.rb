# ServiceCatalographer: app/models/soap_input.rb
#
...
private
  ...
  def generate_json_and_make_inline(make_inline)
    ...
    unless make_inline
      data["soap_input"]["self"] = ServiceCatalographer::Api.uri_for_object(self)
			return data.to_json
    else
      data["soap_input"]["resource"] = ServiceCatalographer::Api.uri_for_object(self)
